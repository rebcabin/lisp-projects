...
;;; Let n be non-prime. Therefore, it has at least two integer factors greater
;;; than 1. Let f be the smallest of n's such factors. Suppose f > (sqrt n).
;;; Then n/f is an integer LTE sqrt n, thus smaller than f. Therefore, f cannot
;;; be n's smallest factor. Reductio ad absurdum; n's smallest factor must be
;;; LTE (sqrt n).
...
(defun scroll-test ()
  "Create two simultaneously scrolling regions."
  (let ((scr (initscr))
